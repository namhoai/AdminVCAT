              ...
              <FormItem>
                {
                  getFieldDecorator('userName', {
                    ...
                    <div style={{ marginTop: 10 }}>
                      <Input prefix={<Icon type="user" style={{ fontSize: 13 }} />} size="large" name="username" placeholder="User Name or Email" onChange={this.handleChange.bind(this)} />
                    </div>
                  )}
              </FormItem>
              <FormItem>
                {
                   getFieldDecorator('password', {
                     ...
                     <div style={{ marginTop: 10 }}>
                       <Input prefix={<Icon type="lock" style={{ fontSize: 13 }} />} size="large" type="password" name="password" placeholder="Password" onChange={this.handleChange.bind(this)} />
                     </div>
                )}
              </FormItem>
              <div style={{ position: 'absolute', bottom: 10, left: 0, width: '100%', padding: '0 20px' }}>
                <Button type="primary" htmlType="submit" loading={this.props.isAuthenticating} style={{ width: '100%' }}>Login</Button>
              </div>
            </Form>
          </div>
        </div>
