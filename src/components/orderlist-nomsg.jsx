...
class NoMsgOrderList extends React.Component {
  constructor() {
    super();
    ...
    this.onBackOrderItem = this.onBackOrderItem.bind(this);
    this.updateOrdersExpressStatus = this.updateOrdersExpressStatus.bind(this);
    this.state = {
      selectedRowKeys: [],
      orderDetailData: {
        disableEdit: false
    ...
    return <div className="orderListnew">
      <div className="clearfix" style={{ marginBottom: 12 }}>
        ...
        <div style={{ float: 'left', display: 'flex' }}>
          <Button type="primary" icon="printer" style={{ margin: '0 5px' }} onClick={this.printOrder}>Print express delivery</Button>
          <Button type="primary" icon="rollback" style={{ margin: '0 5px' }} onClick={this.onBackOrderItem}>Return Order</Button>
          <Button type="primary" icon="to-top" style={{ margin: '0 5px' }} onClick={this.updateOrdersExpressStatus}>Batch delivery</Button>
        </div>
      </div>
      <Table
        columns={columns}
